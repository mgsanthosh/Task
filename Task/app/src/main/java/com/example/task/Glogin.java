...
// }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Glogin.this,"Authentication Failed",Toast.LENGTH_LONG).show();
    ...
    public void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
           ...
           //mDetailTextView.setText(getString(R.string.firebase_status_fmt, user.getDisplayName()));
            ...
            Intent intent = new Intent(Glogin.this,Pull.class);
           ...
           // imageView.setVisibility(View.INVISIBLE);
            ...
            //Intent i = new Intent(Glogin.this, Login.class);
            //startActivity(i);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.signInButton) {
            //mStatusTextView.setText(String.valueOf(R.id.signInButton));
            signIn();
